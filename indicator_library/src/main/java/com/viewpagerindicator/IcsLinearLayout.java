    ...
    protected void measureChildWithMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if (hasDividerBeforeChildAt(index)) {
            if (orientation == VERTICAL) {
                ...
                params.topMargin = marginTop + (int) Math.ceil(mDividerHeight / 2f);
                params.bottomMargin = marginBottom + (int) Math.ceil(mDividerHeight / 2f);
            } else {
                //Account for the divider by pushing everything left
                params.leftMargin = marginLeft + (int) Math.ceil(mDividerWidth / 2f);
                params.rightMargin = marginRight + (int) Math.ceil(mDividerWidth / 2f);
            }
        }
//        final int count = getChildCount();
//        if (index == count - 1) {
//            Log.e("aaaa", params.leftMargin + "==========MarginMarginMargin============" + params.rightMargin);
//            if (hasDividerBeforeChildAt(count)) {
//                if (orientation == VERTICAL) {
//                    params.topMargin += mDividerHeight / 2f;
//                    params.bottomMargin += mDividerHeight / 2f;
//                } else {
//                    params.leftMargin += mDividerWidth / 2;
//                    params.rightMargin += mDividerWidth / 2;
//                }
//            }
//        }
